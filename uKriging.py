...
def Call_SAGA_Module(fDEM):            # pass your input file(s) here
    ...
    # ------------------------------------
    # call module: Universal Kriging
    Module = saga_api.SG_Get_Module_Library_Manager().Get_Module('statistics_kriging','2')
    ...
    Parms.Get(unicode('PREDICTORS')).Set_Value(use_variable_of_dataset_here) # optional data object list
    Parms.Get(unicode('INTERPOL')).Set_Value(4)
    Parms.Get(unicode('COORDS')).Set_Value(0)
